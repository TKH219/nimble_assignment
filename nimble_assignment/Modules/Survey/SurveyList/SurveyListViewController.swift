...
//
    ...
    private lazy var userImageView: UIImageView = {
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(showProfileMenu))
        imageView.isUserInteractionEnabled = true
        imageView.addGestureRecognizer(tapGestureRecognizer)
        
//        imageView.addTarget(viewModel,
//                              action: #selector(viewModel.signIn),
//                              for: .touchUpInside)
//        imageView.target(forAction: <#T##Selector#>, withSender: <#T##Any?#>)
...
//          .disposed(by: disposeBag)
    ...
    override func bindViewToViewModel() {
        ...
        viewModel.getSurvey(loadMore: false)
...
//                viewModel.surveys.skip(1).map { surveys -> [Survey?] in surveys }
//            ]
//        )
//
//        surveys.drive(
